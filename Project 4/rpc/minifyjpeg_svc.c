...
int
_minify_jpeg_proc_1 (JPEG_IN  *argp, void *result, struct svc_req *rqstp)
{
	return (minify_jpeg_proc_1_svc(*argp, result, rqstp));
}
...
minify_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case MINIFY_JPEG_PROC:
		...
		local = (bool_t (*) (char *, void *,  struct svc_req *))_minify_jpeg_proc_1;
		break;
